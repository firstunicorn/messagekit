...
> **STATUS: INCORPORATED** - The removals and simplifications outlined here have been fully integrated into the main feature plan (`add_eventing_features_12bad60a.plan.md`) under Phase 0.
